...
from flaskBlog.form import RegistratioForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm, ResetPasswordForm
...
def login():
    ...
    if forms.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, forms.password.data):
            ...
            return redirect() if next_page else redirect(url_for('Home'))
        else:
...
def account():
    ...
    return render_template('account.html', title='Account', image_file=image_file, form=forms)
...
def new_post():
    ...
    if forms.validate_on_submit():
        ...
        return redirect(url_for('Home'))
    return render_template('create.html', title='New post', form=forms,  legend='New post')
...
def update_post(post_id):
    ...
    return render_template('create.html', title='Update', form=forms, legend='Update post')
